package com.saumyamehta.listkeeper2.adapters;
...
public class AdapterDrops extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements SwipeListener {
    ...
    private static BucketRecyclerView mRecycler;
    private static FirebaseUser mUser;
    private Context context;
    private static Drops mDrops;
    ...
    public void markComplete(final int position) {
        final String[] mWhat = new String[1];
        if (position < mResults.size()) {
            if (mUser != null) {
                String phone  = mUser.getPhoneNumber();
            ...
            mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for (DataSnapshot ds : dataSnapshot.getChildren()) {
                        if (ds.child("what").getValue().toString().equals(mResults.get(position).getWhat())) {
                            mWhat[0] = ds.child("what").getValue().toString();
                    ...
                    Toasty.warning(context,mWhat[0]+ " was marked as complete",Toast.LENGTH_SHORT).show();
        ...
        if (position < mResults.size()) {
            ...
            mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    Toasty.error(context, mWhat[0] + " was removed ", Toast.LENGTH_SHORT).show();
                }
